# Function para humingi ng maraming numbers at ayusin mula highest to lowest
def sort_highest_to_lowest():
    ...
    while True:
        try:
            ...
            # Shield on! Pag nag-type ng letter, wag i-crash. I-break lang ang loop para makapag-sort na.
    ...
    if len(number_list) > 0:
        # Ito yung bagong magic trick! Inaayos nito yung list from highest to lowest dahil sa 'reverse=True'
        number_list.sort(reverse=True)
        
        print("\033[92mNumbers from highest to lowest:\033[0m")
